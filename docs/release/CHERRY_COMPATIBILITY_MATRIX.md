...
| Local runner | Working | `node runner/server.mjs`; 11 runner integration tests (131 across the runner, sandbox, host, executor and bridge suites). Windows/macOS/Linux (pure Node stdlib). |
