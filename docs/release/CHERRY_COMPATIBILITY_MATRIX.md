...
| Claude Code / MCP | Validated, opt-in | Live Claude Code read/verify MCP compatibility recorded 2026-08-29. This is distinct from Mission Control worker execution, which remains uncaptured for Claude Code pending a human sign-in. Provider exit codes never count as verification. |
