...
export const LANDING_SECTIONS: readonly LandingSectionCopy[] = [
  ...
  },
  {
    ...
    heading: 'Several tasks at once, without you tracking them.',
  ...
  },
  {
    ...
    heading: 'Every tool reaches Cherry the same way.',
  ...
  },
  {
    ...
    heading: 'Teach it once and every worker can use it.',
  ...
  },
  {
    ...
    heading: 'Schedule the work, not the prompt.',
  ...
  },
  {
    ...
    heading: 'Cherry stops before anything consequential.',
  ...
  },
  {
    ...
    heading: 'You can recompute every number here.',
    body: 'Cherry holds no credentials, runs workers under allowlists, and treats outside content as untrusted. Every change is written to a ledger whose hash you can recompute yourself.',
  },
  {
    id: 'start',
    number: '11',
